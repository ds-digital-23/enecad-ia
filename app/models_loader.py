...
models_to_download = {
    ...
    "model_la_v1.2.pt": {"url": "https://drive.google.com/uc?id=1FcjDeAnIju0d0tEb_ADIbmEAknQxMIJB", "nome": "Lampada_Acesa"},
}
...
async def download_all_models():
    # Para cada item em models_to_download, extrai 'model_ip_v1.3.pt' e url, e envia para download_model
...
async def load_models():
    ...
    for model_file in model_files:
        ...
        # loaded_models['model_ip_v.1.3.pt'] = {'model': YOLO, 'nome': 'IP'}
        loaded_models[model_file] = {"model": model_ia, "nome": models_to_download[model_file]["nome"]}
    
    print("Modelos carregados:", loaded_models.keys())
